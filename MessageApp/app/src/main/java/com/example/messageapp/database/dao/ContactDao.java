...
public interface ContactDao {
    ...
    //primul raport - selectez sarbatoritii zilei
    @Query("select * from contacte where substr(dataNasterii,1,5) = strftime('%d/%m', 'now')")
    List<Contact> getSarbatoriti();

    //al doilea raport - contactele care s-au imprumutat cu peste 6000 lei (toate creditele)
    ...
    //Contactele care s-au imprumutat cu mai putin de 3000 lei in toate creditele - pt grafic
    ...
    //Contactele care au suma totala imprumutata intre 3000 si 6000 - pt grafic
